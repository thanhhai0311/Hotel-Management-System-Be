...
public class RoomServiceImpl implements RoomService {
    ...
    private static final LocalTime STANDARD_CHECKIN_TIME = LocalTime.of(14, 0);
    ...
    @Override
    public List<RoomResponseDTO> searchAvailableRooms(LocalDate checkInDate, LocalDate checkOutDate) {
        ...
        LocalDateTime checkInTime = checkInDate.atTime(STANDARD_CHECKIN_TIME);
        LocalDateTime checkOutTime = checkOutDate.atTime(STANDARD_CHECKOUT_TIME);

        List<RoomEntity> availableRooms = roomRepository.findAvailableRooms(checkInTime, checkOutTime);

        return availableRooms.stream()
                .map(roomConverter::toResponseDTO)
